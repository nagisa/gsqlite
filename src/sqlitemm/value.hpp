...
#define GEN_VALUE(name, type_enum, type) \
...
GEN_VALUE(IntValue, SQLITE_INTEGER, int64_t);

/// Values of SQLITE_FLOAT fundamental SQLite data type.
GEN_VALUE(FloatValue, SQLITE_FLOAT, double);

/// Values of SQLITE_BLOB fundamental SQLite data type.
GEN_VALUE(BlobValue, SQLITE_BLOB, std::string);

/// Values of SQLITE_TEXT fundamental SQLite data type. UTF-8 encoded.
GEN_VALUE(TextValue, SQLITE_TEXT, Glib::ustring);
